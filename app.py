...
async def confirm_code():
    try:
        ...
        return await Register.confirmAuthenticationDetails(step, api_id, api_hash, phone, phone_code, phone_code_hash)
    except Exception as e:
...
async def confirm_password():
    try:
        ...
        return await Register.confirmAuthenticationDetails(step, api_id, api_hash, phone, phone_code, phone_code_hash, password)
    except Exception as e:
...
async def message():
    req = request.json
    return await msgCtrl.startInterval(req)


@app.route('/message/stop', methods=['POST'])
async def stopMessage():
    req = request.json
    return await msgCtrl.stopInterval()
